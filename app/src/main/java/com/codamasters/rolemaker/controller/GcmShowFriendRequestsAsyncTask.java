 ...
 */
public class GcmShowFriendRequestsAsyncTask extends AsyncTask<Context, Void, String> {
    private static Registration regService = null;
    private GoogleCloudMessaging gcm;
    private Context context;
    private ProgressDialog pDialog;
    private String userID;
    private  ArrayList<String> receivedFriendNames, sentFriendNames;
    private  ArrayList<String> receivedFriendIDs, sentFriendIDs;
    ...
    protected String doInBackground(Context... params) {
        ...
        try {
            ...
            receivedFriendNames = new ArrayList();
            sentFriendNames = new ArrayList();
            receivedFriendIDs = new ArrayList();
            sentFriendIDs = new ArrayList();

            JSONParser parser=new JSONParser();
            String s = user.getFriendRequestsReceived();
            try {
                ...
                for(int i = 0; i < array.size(); i++){
                    ...
                    receivedFriendNames.add(friend.getName());
                    receivedFriendIDs.add(friend.getId().toString());
                }
            ...
            try {
                ...
                for(int i = 0; i < array.size(); i++){
                    id = Long.parseLong((String) array.get(i));
                    friend = regService.findRecord(id).execute();
                    sentFriendNames.add(friend.getName());
                    sentFriendIDs.add(friend.getId().toString());
                }
            } catch (org.json.simple.parser.ParseException e) {
                e.printStackTrace();
            }
    ...
    protected void onPostExecute(String msg) {
        ...
        ShowFriendRequestsFragment.ListRequests(sentFriendNames, sentFriendIDs, receivedFriendNames, receivedFriendIDs);
