 ...
 */
public class GcmDeleteGameAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    public GcmDeleteGameAsyncTask(Context context, String gameID) {
    ...
    protected String doInBackground(Context... params) {
        ...
        String msg = "";
        try {
            Log.d("Borrando juego", gameID);
            regService.deleteGame(gameID).execute();
