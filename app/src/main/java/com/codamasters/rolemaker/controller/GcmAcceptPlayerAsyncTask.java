 ...
 */
public class GcmAcceptPlayerAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    public GcmAcceptPlayerAsyncTask(Context context, String gameID, String playerID) {
    ...
    protected String doInBackground(Context... params) {
        ...
        String msg = "";
        try {
            regService.acceptPlayer(gameID, playerID).execute();
