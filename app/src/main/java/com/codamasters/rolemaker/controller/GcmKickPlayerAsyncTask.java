 ...
 */
public class GcmKickPlayerAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    public GcmKickPlayerAsyncTask(Context context, String gameID, String playerID) {
    ...
    protected void onPreExecute() {
        ...
        pDialog.setMessage("Kicking player");
    ...
    protected String doInBackground(Context... params) {
        ...
        String msg = "";
        try {
            regService.kickPlayer(gameID, playerID).execute();
