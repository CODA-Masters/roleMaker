...
import com.codamasters.rolemaker.controller.GcmReceiveMessageService;
...
public class ChatFragment2 extends Fragment {
    ...
    public static ChatFragment2 newInstance(String param1,ArrayList<String> uIDs, String gID) {
    ...
    public void onResume(){
        ...
        adapter.notifyDataSetChanged();
        open=true;
        GcmReceiveMessageService.setNum_messages(0);
