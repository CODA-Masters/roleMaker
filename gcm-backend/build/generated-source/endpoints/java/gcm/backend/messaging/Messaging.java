...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "sendText".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link SendText#execute()} method to invoke the remote operation.
   *
   * @param message
   * @return the request
   */
  public SendText sendText(java.lang.String message) throws java.io.IOException {
    SendText result = new SendText(message);
    initialize(result);
    return result;
  }

  public class SendText extends MessagingRequest<Void> {

    private static final String REST_PATH = "sendText/{message}";

    /**
     * Create a request for the method "sendText".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link SendText#execute()} method to invoke the remote operation.
     * <p> {@link
     * SendText#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param message
     * @since 1.13
     */
    protected SendText(java.lang.String message) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
      this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
    }

    @Override
    public SendText setAlt(java.lang.String alt) {
      return (SendText) super.setAlt(alt);
    }

    @Override
    public SendText setFields(java.lang.String fields) {
      return (SendText) super.setFields(fields);
    }

    @Override
    public SendText setKey(java.lang.String key) {
      return (SendText) super.setKey(key);
    }

    @Override
    public SendText setOauthToken(java.lang.String oauthToken) {
      return (SendText) super.setOauthToken(oauthToken);
    }

    @Override
    public SendText setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendText) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendText setQuotaUser(java.lang.String quotaUser) {
      return (SendText) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendText setUserIp(java.lang.String userIp) {
      return (SendText) super.setUserIp(userIp);
    }
    ...
    public SendText setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }

    @Override
    public SendText set(String parameterName, Object value) {
      return (SendText) super.set(parameterName, value);
    }
  }
