...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<gcm.backend.registration.model.CollectionResponseUserRecord> {
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String regName) throws java.io.IOException {
    Register result = new Register(regId, regName);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{regName}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String regName) {
