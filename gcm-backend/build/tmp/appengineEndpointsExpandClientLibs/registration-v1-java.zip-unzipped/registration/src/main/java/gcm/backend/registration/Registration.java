...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AddFriend addFriend(java.lang.String addUserID, java.lang.String addFriendID) throws java.io.IOException {
    AddFriend result = new AddFriend(addUserID, addFriendID);
    initialize(result);
    return result;
  }
  ...
  public class AddFriend extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "addFriend/{addUserID}/{addFriendID}";
     ...
     * @since 1.13
     */
    protected AddFriend(java.lang.String addUserID, java.lang.String addFriendID) {
      super(Registration.this, "POST", REST_PATH, null, Void.class);
      this.addUserID = com.google.api.client.util.Preconditions.checkNotNull(addUserID, "Required parameter addUserID must be specified.");
      this.addFriendID = com.google.api.client.util.Preconditions.checkNotNull(addFriendID, "Required parameter addFriendID must be specified.");
    }
    ...
    public AddFriend setAddUserID(java.lang.String addUserID) {
      this.addUserID = addUserID;
      return this;
    }

    @com.google.api.client.util.Key
    private java.lang.String addFriendID;

    /**

     */
    public java.lang.String getAddFriendID() {
      return addFriendID;
    }

    public AddFriend setAddFriendID(java.lang.String addFriendID) {
  ...
  public class ListFriends extends RegistrationRequest<gcm.backend.registration.model.UserRecord> {

    private static final String REST_PATH = "listFriends/{userID}";
    ...
    protected ListFriends(java.lang.String userID) {
      super(Registration.this, "GET", REST_PATH, null, gcm.backend.registration.model.UserRecord.class);
   ...
   *
   * @param removeUserID
   * @param removeFriendID
   * @return the request
   */
  public RemoveFriend removeFriend(java.lang.String removeUserID, java.lang.String removeFriendID) throws java.io.IOException {
    RemoveFriend result = new RemoveFriend(removeUserID, removeFriendID);
    initialize(result);
    return result;
  }
  ...
  public class RemoveFriend extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "friend/{removeUserID}/{removeFriendID}";
     ...
     * @since 1.13
     */
    protected RemoveFriend(java.lang.String removeUserID, java.lang.String removeFriendID) {
      super(Registration.this, "DELETE", REST_PATH, null, Void.class);
      this.removeUserID = com.google.api.client.util.Preconditions.checkNotNull(removeUserID, "Required parameter removeUserID must be specified.");
      this.removeFriendID = com.google.api.client.util.Preconditions.checkNotNull(removeFriendID, "Required parameter removeFriendID must be specified.");
    }
    ...
    @com.google.api.client.util.Key
    private java.lang.String removeUserID;

    /**

     */
    public java.lang.String getRemoveUserID() {
      return removeUserID;
    }

    public RemoveFriend setRemoveUserID(java.lang.String removeUserID) {
      this.removeUserID = removeUserID;
      return this;
    }

    @com.google.api.client.util.Key
    private java.lang.String removeFriendID;

    /**

     */
    public java.lang.String getRemoveFriendID() {
      return removeFriendID;
    }

    public RemoveFriend setRemoveFriendID(java.lang.String removeFriendID) {
